...
export const copy = {
  en: {
    ...
    headline: "Create pixel art in your browser.",
    intro:
    ...
    exports: "exports",
    examplesTitle: "Export GIFs and spritesheets",
    examplesText: "Turn your frames into animated previews or engine-ready sprite assets.",
    gifShowcaseTitle: "Animated GIF export",
    gifShowcaseText: "Preview movement and share compact animated pixel art loops.",
    spritesheetShowcaseTitle: "Spritesheet export",
    spritesheetShowcaseText: "Pack animation frames into one sheet for games, engines, and asset pipelines.",
  ...
  ko: {
    ...
    headline: "브라우저에서 픽셀 아트를 만들어보세요.",
    intro:
      "설치 없이 아이콘, 게임 스프라이트, 프레임 애니메이션, 제한 팔레트 아트를 그릴 수 있습니다. 깔끔한 32 x 32 캔버스에서 시작해 작품을 완성해보세요.",
    defaultCanvas: "기본 캔버스",
    frameCels: "프레임 셀",
    exports: "내보내기",
    examplesTitle: "GIF와 스프라이트시트 내보내기",
    examplesText: "프레임을 움직이는 미리보기나 게임용 스프라이트 에셋으로 만들 수 있습니다.",
    gifShowcaseTitle: "GIF 애니메이션 내보내기",
    gifShowcaseText: "움직임을 확인하고 짧은 픽셀 아트 애니메이션으로 공유할 수 있습니다.",
    spritesheetShowcaseTitle: "스프라이트시트 내보내기",
    spritesheetShowcaseText: "여러 프레임을 하나의 이미지로 묶어 게임 엔진이나 작업 파이프라인에 사용할 수 있습니다.",
